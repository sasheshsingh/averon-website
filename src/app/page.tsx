...
export default function Home() {
  return <div>
    ...
    <LogoTicker />
    {/*<Testimonials />*/}
    <BoardingImage image="https://img.freepik.com/free-photo/aerial-drones-fly-modern-skies-with-technology-generated-by-ai_188544-29867.jpg?t=st=1738013903~exp=1738017503~hmac=02fc308d7c675f4ae550fd9f7238f84ded79346695dc0434517b54d1bd2a3d08&w=1380" title="Next-Gen Drone Technology" paragraph="Next-gen drone technology integrates AI, advanced sensors, and autonomous systems, enabling seamless navigation, enhanced performance, and versatile applications in fields like logistics, surveillance, and environmental monitoring."/>
    <FeatureSection />
