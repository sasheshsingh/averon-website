  ...
  return (
    <div>
      ...
      <BoardingVideo
        ...
        paragraph="Next-gen drone technology integrates AI, advanced sensors, and autonomous systems, enabling seamless navigation, enhanced performance, and versatile applications in fields like logistics, surveillance, and environmental monitoring."
      />
      <FeatureSection />
      <BoardingImage
        ...
        paragraph="A fast and lightweight drone combines high speed with portability, making it ideal for agile maneuvers, quick deployment, and efficient operation across various applications."
      />
    </div>
  );
}
