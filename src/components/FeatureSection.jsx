        ...
        <div className="relative mt-20 border-b border-neutral-800 min-h-[800px] container py-24 mx-auto mr-auto ml-auto">
            <div className="text-center">
                <h1 className="text-7xl mt-20 tracking wide">
                    Features
                <span className="bg-gradient-to-r from-gray-300 to-gray-700 text-transparent bg-clip-text"> of Averon</span>
                </h1>
            </div>
            <div className="flex flex-wrap mt-20">
                {features.map((feature,index) =>(
                    <div key={index} className="w-1/3">
                        ...
                        {/*</div>*/}
                        <h5 className="mt-1 mb-6 text-xl text-orange-500 ">{feature.text}</h5>
